...
call s:HL('Search',    s:yellow, s:none, s:underline)
call s:HL('IncSearch', s:hls_cursor, s:none, s:underline)
...
call s:HL('Folded', s:gb.bg4, s:none, s:italic)
...
" Alternative setting
call s:HL('DiffChange', s:aqua, s:none, s:inverse)
